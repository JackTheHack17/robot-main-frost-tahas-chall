...
public class APSwerveControllerCommand extends CommandBase {
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      APSwerveControllerCommand::defaultLogError;
   ...
   */
  public APSwerveControllerCommand(
  ...
  public void execute() {
    ...
    if(currentTime < transformedTrajectory.getTotalTimeSeconds()) {
        desiredState = (PathPlannerState) transformedTrajectory.sample(currentTime); }
    else desiredState = (PathPlannerState) transformedTrajectory.sample(transformedTrajectory.getTotalTimeSeconds());
  ...
  public static void setLoggingCallbacks(
    ...
    APSwerveControllerCommand.logActiveTrajectory = logActiveTrajectory;
    APSwerveControllerCommand.logTargetPose = logTargetPose;
    APSwerveControllerCommand.logSetpoint = logSetpoint;
    APSwerveControllerCommand.logError = logError;
  }
}