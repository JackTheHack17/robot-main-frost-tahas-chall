...
public final class Constants {
    ...
    public static final class ARM {
        ...
        public static ArmPosition scoreHighConePosition  = new ArmPosition(235, 44, 155);
        public static ArmPosition dipHighConePosition    = new ArmPosition(217, 38, 136);
        public static ArmPosition scoreHighCubePosition  = new ArmPosition(184, 77, 120);
        public static ArmPosition scoreMidConePosition   = new ArmPosition(133.5, 88, 139);
        public static ArmPosition dipMidConePosition     = new ArmPosition(133.5, 75, 139);
        public static ArmPosition scoreMidCubePosition   = new ArmPosition(133.5, 126, 100);
        public static ArmPosition idlePosition           = new ArmPosition(133.5, 142,  39);//131 217 50
        public static ArmPosition scoreLowPosition       = new ArmPosition(133.5, 112,   55);
        public static ArmPosition floorPosition          = new ArmPosition(133.5, 37, 141);
        public static ArmPosition floorAltPosition   = new ArmPosition(133.5, 64, 85);
        public static ArmPosition substationPosition     = new ArmPosition(133.5, 117,   107);
        ...
        public static final double STAGE_2_Kp = 0.014;//0.035//0.04//0.0325//0.008
        public static final double STAGE_2_Ki = 0.00;//0.0025 //0.0065
        public static final double STAGE_2_Kd = 0.0051;//0.0051;//0.0042//0.00420//0.035 0.0043
        ...
        public static final double STAGE_3_Kp = 0.02;//0.0255//0.0155;//0.005
        public static final double STAGE_3_Ki = 0;
        public static final double STAGE_3_Kd = 0.00005;//0.000
