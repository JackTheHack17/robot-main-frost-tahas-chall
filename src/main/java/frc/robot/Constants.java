...
public final class Constants {
    ...
    public static final class ARM {
        ...
        public static ArmPosition scoreHighConePosition = new ArmPosition(240, 110, 177);
        public static ArmPosition dipHighConePosition = new ArmPosition(220, 65, 145);
        public static ArmPosition scoreHighCubePosition = new ArmPosition(185, 106, 127);
        public static ArmPosition scoreMidConePosition = new ArmPosition(133.5, 135, 160);
        public static ArmPosition dipMidConePosition = new ArmPosition(133.5, 115, 120);
        public static ArmPosition scoreMidCubePosition = new ArmPosition(133.5, 150, 97);
        public static ArmPosition idlePosition = new ArmPosition(133.5, 177, 36);// 131 217 50
        public static ArmPosition scoreLowPosition = new ArmPosition(133.5, 135, 52);
        public static ArmPosition floorPosition = new ArmPosition(133.5, 66, 139);
        public static ArmPosition floorAltPosition = new ArmPosition(133.5, 102, 43);
        // public static ArmPosition floorAltCubePosition = new ArmPosition(133.5, 91, 43);
        public static ArmPosition substationPosition = new ArmPosition(133.5, 155, 111);
        ...
        public static final double STAGE_2_MAX_ACCEL = 300;// 210;//200//190;//180;//160;//170//150
